...
module.exports = class RendererFactory {
    constructor (opts) {
        ...
        this.factories = {
            [MapnikRendererFactory.NAME]: new MapnikRendererFactory(opts.mapnik),
            [TorqueRendererFactory.NAME]: new TorqueRendererFactory(opts.torque),
            [PlainRendererFactory.NAME]: new PlainRendererFactory(),
            [BlendRendererFactory.NAME]: new BlendRendererFactory(this),
            [HttpRendererFactory.NAME]: new HttpRendererFactory(opts.http),
            [PgMvtRendererFactory.NAME]: new PgMvtRendererFactory(opts.mvt)
        };
