...
TileBackend.prototype.getTile = function(mapConfigProvider, params, callback) {
    ...
    step(
        ...
        function(err, r, is_cached) {
            ...
            renderer.getTile(+params.z, +params.x, +params.y, {
                requestId: params.requestId
            }, this);
        },
        function(err, tile, headers, stats, requestId) {
            ...
            callback(err, tile, _.extend(extraHeaders, headers), _.extend(timer.getTimes(), stats), requestId);
        }
    );
};
