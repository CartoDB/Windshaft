...
TileBackend.prototype.getTile = function (mapConfigProvider, params, callback) {
    ...
    this._rendererCache.getRenderer(mapConfigProvider, function (err, renderer, is_cached) {
        ...
        renderer.getTile(+params.z, +params.x, +params.y, function (err, tile, headers, stats) {
            ...
            callback(err, tile, Object.assign(extraHeaders, headers), Object.assign(timer.getTimes(), stats));
        });
    });
};
