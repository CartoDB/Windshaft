...
//                       getImage = function(mapConfigProvider, format, width, height, bounds,       options,
//                                           callback) {
PreviewBackend.prototype.getImage = function(mapConfigProvider, format, width, height, zoom, center, options,
                                             callback) {
    if (!callback) {
        callback = options;
        options = {};
