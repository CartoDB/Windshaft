...
PreviewBackend.prototype.getImage = function(mapConfigProvider, params, width, height, zoom, center, callback) {
    if (!callback) {
    ...
    step(
        function() {
            self._rendererCache.getRenderer(mapConfigProvider, params, this);
        },
