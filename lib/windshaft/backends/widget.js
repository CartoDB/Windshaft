...
WidgetBackend.prototype.getWidget = function (mapConfigProvider, params, callback) {
    ...
    step(
        ...
        function runWidgetQuery(err, _widget) {
            ...
            var overrideParams = _.reduce(_.pick(params, 'start', 'end', 'bins', 'column_type'),
...
WidgetBackend.prototype.search = function (mapConfigProvider, params, callback) {
    var timer = new Timer();
    ...
    step(
        ...
        function runWidgetQuery(err, _widget) {
            ...
            var filters = mapConfig.getLayerFilters(layerIndex, params.widgetName);
            if (params.bbox) {
                filters = filters.concat(new BBoxFilter({}, {bbox: params.bbox}));
            }
            ...
            widget.search(pg, filters, userQuery, this);
        },
        function returnCallback(err, result) {
            return callback(err, result, timer.getTimes());
        }
