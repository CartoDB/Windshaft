    ...
    step(
        ...
        function runWidgetQuery(err, _widget) {
            ...
            if (widget.getType() === 'histogram') {
                ...
                var override = _.reduce(_.pick(params, 'start', 'end', 'bins'), function(overrides, val, k) {
                    overrides[k] = +val;
                    return overrides;
                }, {});

                widget.getResult(pg, allFilters, noOwnFilters, override, this);
            }
