...
MapValidatorBackend.prototype.validate = function(mapConfigProvider, callback) {
    ...
    mapConfigProvider.getMapConfig(function(err, mapConfig, params) {
        ...
        if (mapConfig.isVectorLayergroup()) {
            return self.validateVectorLayergroup(mapConfig, params, callback);
        }
...
MapValidatorBackend.prototype.validateVectorLayergroup = function (mapConfig, params, callback) {
    callback(null, true);
};
