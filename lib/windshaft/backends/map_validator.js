    ...
    mapConfigProvider.getMapConfig(function(err, mapConfig, params) {
        ...
        step(
            ...
            function validate$checkFailingMapnikTileLayer (errAllLayers) {
                ...
                var checkFailingMapnikLayerQueue = d3.queue(checkFailingMapnikTileLayerFns.length);
            ...
            function validate$remaningFormatLayers (err) {
                ...
                if (validateRemainingFormatLayerFns.length === 0) {
                    return next(err);
                }

                var validationQueue = d3.queue(validateRemainingFormatLayerFns.length);
