...
console.log("get{Tile,Grid} ERROR: "); console.dir(err);
    ...
    app.createLayergroup = function(cfg, req, callback) {
        ...
        testX = testY = testZ = 0;  // TODO: take as a parameter!
        ...
        Step(
            function initLayergroup(){
                ...
                if ( cfg.hasOwnProperty('test_tile') ) {
                  if ( cfg.test_tile.length != 3 ) throw new Error("test_tile must have exactly 3 elements: Z,X,Y");
                  textZ = cfg.test_tile[0];
                  textX = cfg.test_tile[1];
                  textY = cfg.test_tile[2];
                }
                ...
                opts.interactivity = interactivity;
            ...
            function posLayerCreate(err, token) {
                if (err) throw err;
            ...
            function tryFetchGrid(err){
                ...
                var tryFetchingGrid = ( interactive.length > 0 );
                ...
                var next = function(err) {
                  ...
                  if ( ! interactive.length ) { finish(); return; }
