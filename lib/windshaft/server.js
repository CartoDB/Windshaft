    ...
    app.fetchTilesetMetadata = function(req, token, rendererType, layerId, callback) {
        ...
        Step(
            ...
            function(err, r) {
                if (err) throw err;
                renderer = r;
                return renderer.get().getMetadata();
            },
            function(err, meta) {
...
console.log("Error since last attempt to fetch torque metadata: " + err);
    ...
    app.get(app.base_url_notable + '/layergroup/:token/:z/:x/:y.:format', function(req, res) {
    ...
    app.get(app.base_url_notable + '/layergroup/:token/:layer/:z/:x/:y.(:format)', function(req, res) {
    ...
    // Gets attributes for a given layer feature 
    app.get(app.base_url_notable + '/layergroup/:token/:layer/attributes/:fid', function(req, res) {
