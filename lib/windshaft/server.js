        ...
        Step(
            function initLayergroup(){
                ...
                for ( var i=0; i<cfg.layers.length; ++i ) {
                  ...
                  if ( ! lyr.type || lyr.type == 'cartodb' ) hasMapnikLayers = true;
            ...
            function tryFetchGrid(err){
                ...
                var tryFetchingGrid = firstTimeSeen && hasMapnikLayers;
        ...
        Step(
            ...
            function finish(err, response){
                ...
                if (err){
                    ...
                    statusCode = 400;
                    // TODO: Find an appropriate statusCode
                    app.sendError(res, response, statusCode, 'POST LAYERGROUP', err.message);
                } else {
