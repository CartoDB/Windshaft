...
console.log("getRenderer ERROR: "); console.dir(err);
    ...
    app.createLayergroup = function(cfg, req, callback) {
        ...
        Step(
            function initLayergroup(){
                ...
                if ( req.profiler ) req.profiler.done('initLayergroup.mml_builder');
    ...
    app.get(app.base_url_notable + '/layergroup/:token/print.png', function(req, res) {
        Step(
            function(){
                app.req2params(req, this);
            },
            function(err, r) {
                render_cache.printMap(req, this);
            },
            function(err, what) {
                res.send(what, 200);
            }
