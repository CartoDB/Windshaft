...
module.exports = function(opts) {
    ...
    var attributesBackend = new AttributesBackend(rendererCache, map_store);
    ...
    var mapController = new MapController(app, mapBackend, tileBackend, attributesBackend, {
    ...
    var staticMapsController = new StaticMapsController(app, previewBackend);
