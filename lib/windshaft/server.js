...
module.exports = function(opts) {
    ...
    var rendererCache = new RendererCache(renderCacheOpts, map_store, rendererFactory);
    var rendererStatsReporter = new RendererStatsReporter(rendererCache, renderCacheOpts.statsInterval);
    rendererStatsReporter.start();

    // Make map store accessible as part of the app
    app.mapStore = map_store;

    var mapBackend = new MapBackend(app, rendererCache, map_store);
