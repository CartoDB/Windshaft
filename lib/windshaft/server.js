...
module.exports = function(opts){
    ...
    var HttpRendererFactory = require('./renderers/http').factory,
        httpRendererOpts = opts.renderer && opts.renderer.http || {},
        httpRendererFactory = new HttpRendererFactory(
            httpRendererOpts.whitelist,
            httpRendererOpts.timeout,
            httpRendererOpts.proxy
        );
    ...
    var render_cache = new RenderCache(renderCacheOpts, mml_store, map_store, opts.mapnik, httpRendererFactory);
    ...
    app.createLayergroup = function(cfg, req, callback) {
        ...
        Step(
            function initLayergroup(){
                ...
                if ( ! semver.satisfies(version, '>= 1.0.0 <= 1.3.0-alpha') ) {
                ...
                cfg.layers.forEach(function(lyr, i) {
    ...
    var StaticMapsController = require('./controllers/static_maps'),
        staticMapsController = new StaticMapsController(app, render_cache, map_store, httpRendererFactory);
