...
module.exports = function(timeout, mml_store, mapnik_opts) {
    ...
    var renderKey = baseKey + "<%= dbuser %>:<%= format %>:<%= geom_type %>:<%= sql %>:<%= interactivity %>:<%= style %>:<%= style_version %>";
    ...
    me.createKey = function(params, base) {
        ...
        _.defaults(opts, {
          ...
          interactivity:'', style:'', style_version:''
        });
        ...
        Step(
            ...
            function loadMapnik(err, data){
                ...
                var query = {
                    ...
                    bufferSize: that.mapnik_opts.buffer_size
                };
