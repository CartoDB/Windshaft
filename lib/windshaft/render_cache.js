...
require('tilelive-mapnik-cartodb').registerProtocols(tilelive);
...
module.exports = function(timeout, mml_store){
    ...
    me.getRenderer = function(req, callback){
        ...
        // TODO: REMOVE/FIX
        // this is bad as it deletes all cached renderers on each request
        // if the cache_buster param is present, not just updated
        //
        // the reason this exists is to ensure a totally fresh renderer
        // is used when viewing tiles inside an admin GUI.
