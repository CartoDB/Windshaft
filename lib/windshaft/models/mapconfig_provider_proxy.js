...
MapConfigProviderProxy.prototype.getMapConfig = function(callback) {
    ...
    this.mapConfigProvider.getMapConfig(function(err, mapConfig, params, context) {
        return callback(err, mapConfig, _.extend({}, params, self.params), context);
    });
};
...
MapConfigProviderProxy.prototype.filter = function(key) {
    return this.mapConfigProvider.filter.apply(this, [key]);
};
