...
RendererFactory.prototype.makeRenderer = function (mapConfig, params, context, callback) {
    ...
    var layerType = mapConfig.layerType(params.layer);
    console.log(layerType);
    console.log(Object.keys(this.factories));
    var factory = this.factories[layerType];
    console.log(factory);

    if (!factory) {
        return callback(new Error("Layer type '" + layerType + "' not supported"));
    }
