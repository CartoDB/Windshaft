...
RendererFactory.prototype.makeRendererHttp = function(params, mapConfig, callback) {
    ...
    return genericMakeRenderer(
        this.httpRendererFactory, HttpRenderer.adaptor, mapConfig, {}, params.format, params.layer, callback
    );
};
...
RendererFactory.prototype.makeRendererPlain = function(params, mapConfig, callback) {
    ...
    return genericMakeRenderer(
        this.plainRendererFactory, PlainRenderer.adaptor, mapConfig, {}, params.format, params.layer, callback
    );
};
