...
RendererFactory.prototype.makeRenderer = function(mapConfig, params, callback) {
    ...
    if ( params.layer === 'all' ) {
        this.makeRendererBlend(mapConfig, params, callback);
    }
    else if ( params.format.match(/^(png|grid\.json)$/) ) {
        this.makeRendererMapnik(mapConfig, params, callback);
    }
...
RendererFactory.prototype.makeRendererMapnik = function (mapConfig, params, callback) {
...
RendererFactory.prototype.makeRendererBlend = function (mapConfig, params, callback) {
    if (!params.token) {
...
function genericMakeRenderer(factory, AdaptorClass, mapConfig, params, format, layer, limits, callback) {
    var options = {
        params: params,
        layer: layer,
        limits: limits
