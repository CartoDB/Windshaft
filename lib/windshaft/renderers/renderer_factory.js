...
function RendererFactory(opts) {
    ...
    this.mapnikRendererFactory = new MapnikRenderer.factory(opts.mapnik.mmlStore, {
        mapnik_opts: opts.mapnik.opts,
        createKeyFn: RendererParams.createKey
    });
...
RendererFactory.prototype.makeRendererTorque = function(params, mapConfig, callback){
    ...
    Step(
        function initRenderer() {
            ...
            self.torqueRendererFactory.getRenderer(mapConfig.obj(), dbParams, format, layer, this);
        },
