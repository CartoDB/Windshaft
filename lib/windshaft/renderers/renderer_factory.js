...
RendererFactory.prototype.makeRenderer = function (mapConfig, params, context, callback) {
    ...
    if (typeof params.layer === 'undefined') {
        return this.genericMakeRenderer(this.mapnikRendererFactory, mapConfig, params, params.format, params.layer,
            limits, this.onTileErrorStrategy, callback);
    }

    // aliases, like `all`, `raster`
    if (params.layer === 'all') {
        return this.genericMakeRenderer(this.blendRendererFactory, mapConfig, params, 'png', null, limits, callback);
    }
    ...
    return this.genericMakeRenderer(factory, mapConfig, params, params.format, params.layer, limits,
        this.onTileErrorStrategy, callback);
};

RendererFactory.prototype.makeRendererMapnik = function (mapConfig, params, limits, callback) {
    return this.genericMakeRenderer(this.mapnikRendererFactory, mapConfig, params, params.format, params.layer, limits,
        this.onTileErrorStrategy, callback);
};

RendererFactory.prototype.makeRendererTorque = function (mapConfig, params, callback) {
    return this.genericMakeRenderer(this.torqueRendererFactory, mapConfig, params, params.format, params.layer, {},
        callback);
};

RendererFactory.prototype.makeRendererHttp = function (mapConfig, params, callback) {
    return this.genericMakeRenderer(
        this.httpRendererFactory, mapConfig, params, params.format, params.layer, {}, callback);
};

RendererFactory.prototype.makeRendererPlain = function (mapConfig, params, callback) {
    return this.genericMakeRenderer(
        this.plainRendererFactory, mapConfig, params, params.format, params.layer, {}, callback);
};

RendererFactory.prototype.genericMakeRenderer = function(factory, mapConfig, params, format, layer, limits,
                                                         onTileErrorStrategy, callback) {
    if (!callback) {
