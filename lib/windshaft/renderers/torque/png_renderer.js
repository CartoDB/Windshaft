...
function PngRenderer(layer, sql, attrs, options) {
    options = options || {};
    var cartoCssOptions = torque.common.TorqueLayer.optionsFromCartoCSS(layer.options.cartocss);
    options.bufferSize = cartoCssOptions['buffer-size'] !== undefined ? cartoCssOptions['buffer-size'] : 32;

    Renderer.apply(this, [layer, sql, attrs, options]);
