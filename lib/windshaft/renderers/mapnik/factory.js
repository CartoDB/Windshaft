...
function snapToGridQueryEnabled(geomColumnType) {
    return isGeometryColumnType(geomColumnType)
        && !!global.environment.renderer.snapToGrid;
}

function snapToGridAndClipByBox2DQueryEnabled(geomColumnType) {
    return isGeometryColumnType(geomColumnType)
        && !!global.environment.renderer.snapToGrid && !!global.environment.renderer.clipByBox2d;
}
