...
MapnikFactory.prototype.getMapnikRenderer = function(mapConfig, format, options, callback) {
    ...
    params = _.defaults(params, this.mapConfigToMMLBuilderConfig(mapConfig, this._mapnik_opts.queryRewriter, options));
...
MapnikFactory.prototype.mapConfigToMMLBuilderConfig = function(mapConfig, queryRewriter, options) {
    ...
    for ( var i=0; i<cfg.layers.length; ++i ) {
        ...
        var query = queryRewriter.query(lyropt.sql, lyropt.query_rewrite_data, options.params.z);
