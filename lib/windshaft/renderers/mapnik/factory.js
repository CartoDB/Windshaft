...
MapnikFactory.prototype.getAdaptor = function(renderer, format, onTileErrorStrategy) {
    if (format === FORMAT_MVT || format === 'topojson') {
...
MapnikFactory.prototype.getRenderer = function (mapConfig, format, options, callback) {
    if (format === 'topojson') {
        return this.getTopoJsonRenderer(mapConfig, format, options, callback);
    }
    return this.getMapnikRenderer(mapConfig, format, options, callback);
};

MapnikFactory.prototype.getTopoJsonRenderer = function(mapConfig, format, options, callback) {
    var topoJsonRenderer = {};

    callback(null, topoJsonRenderer);
};
