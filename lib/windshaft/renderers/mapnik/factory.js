...
MapnikFactory.prototype.getRenderer = function(mapConfig, format, options, callback) {
    ...
    step(
        function prepareParams() {
            self.mapConfigToMMLBuilderConfig(mapConfig, params, this);
        },
...
MapnikFactory.prototype.mapConfigToMMLBuilderConfig = function(mapConfig, params, callback) {
    ...
    overviewsQuery(mapConfig, params, function(err, queryResult) {
        if (err) {
            return callback(err);
        }

        console.log('prepared queries: %j', queryResult);

        return callback(null, opts);
    });
};

function overviewsQuery(mapConfig, params, callback) {
