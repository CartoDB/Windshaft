...
GeojsonRenderer.prototype._getTileData = function(cartoPSQL, coord, zoom, layer, callback) {
    ...
    var cartoDBPostgisUtils = new CartoDBPostgisUtils(this.options.tileSize, this.options.maxGeosize, this.options.bufferSize);
    ...
    var query = self._composeGeojsonQuery({
        ...
        xyzResolution: cartoDBPostgisUtils.cdbXYZResolution(zoom),
