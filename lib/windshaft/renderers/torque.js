...
//           - constructor(params) where params should contain host, port, database, user, password.
//                                 the class is always constructed with dbParams passed to getRender as-is
//
//           - query(sql, callback(err, data)) -> gets an SQL query and return a javasrip object with { schema: {}, rows: []} 
//                          see CartoDB-SQL-API response reference for more datails (https://github.com/CartoDB/CartoDB-SQL-API/blob/1.8.2/doc/API.md#json)
