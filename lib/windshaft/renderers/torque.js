...
//
//           - query(sql, callback(data)) -> gets an SQL query and return a javasrip object with { schema: {}, rows: []} 
//                          see CartoDB-SQL-API response reference for more datails (link needed)
