...
function Factory(whitelist, timeout, proxy) {
    whitelist = whitelist || [];
...
Factory.prototype.name = 'http';
Factory.prototype.supported_formats = ['png'];

Factory.prototype.getRenderer = function(mapConfig, dbParams, format, layerNumber, callback) {
