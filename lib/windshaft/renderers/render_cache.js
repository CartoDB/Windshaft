...
//  - Reports stats (not a clear responsibility) about:
//    * Total number of renderers
//    * For mapnik renderers the mapnik-pool status (for sure this should not be here)
        ...
        if (this.shouldRecreateRenderer(cache_entry, cache_buster)) {
            ...
            step(
                ...
                function makeRenderer (err, mapConfig) {
                    ...
                    rendererFactory.makeRenderer(mapConfig, _.extend({}, params), context, function (err, renderer) {
                        if (!err && req.profiler) {
