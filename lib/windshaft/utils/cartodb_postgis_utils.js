...
function CartoDBPostgisUtils (tileSize, maxGeosize) {
    ...
    if (maxGeosize) {
        this.tileMaxGeosize = new Decimal(maxGeosize);
    } else {
        // 6378137: earth circumference in webmercator 3857
        // Decimal.acos(-1): PI
        this.tileMaxGeosize = new Decimal(6378137).times(Decimal.acos(-1)).times(2);
    }
