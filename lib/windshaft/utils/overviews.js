...
function overviews_query(query, overviews) {
    if ( !overviews || !overviews_supported_query(query)) {
        return query;
    }
...
function overviews_supported_query(sql) {
  return !!sql.match(
...
module.exports = {
  is_supported_query: overviews_supported_query,
  query: overviews_query,
  style: overviews_style
};
