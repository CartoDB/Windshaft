...
MapController.prototype.tileOrLayer = function (req, res) {
    this._app.doCORS(res);
    return getTileOrGrid(this._app, this._mapBackend, req, res);
};

function getTileOrGrid(app, mapBackend, req, res) {
    step(
        function() {
        ...
        function(err) {
            ...
            mapBackend.getTileOrGrid(req, res, this);
        },
...
module.exports.getTileOrGrid = getTileOrGrid;
