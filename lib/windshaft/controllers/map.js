 ...
 * @constructor
 */
function MapController(app, mapBackend, tileBackend, attributesBackend, options) {
    options = options || {};
...
MapController.prototype.create = function(req, res, prepareConfigFn) {
    ...
    var layergroupDecorator = {
        beforeLayergroupCreate: function(requestMapConfig, callback) {
            self.beforeLayergroupCreate(req, requestMapConfig, callback);
        },
        afterLayergroupCreate: function(layergroup, response, callback) {
            self.afterLayergroupCreate(req, layergroup, response, callback);
        }
    };
...
MapController.prototype.tileOrLayer = function (req, res) {
    ...
    step(
        ...
        function mapController$getTile(err) {
            ...
            self.tileBackend.getTile(req.params, this);
        },
