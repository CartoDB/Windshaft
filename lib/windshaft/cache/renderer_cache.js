...
RendererCache.prototype.getRenderer = function(req, callback) {
    ...
    if (this.shouldRecreateRenderer(cache_entry, cache_buster)) {
        ...
        step(
            ...
            function makeRenderer (err, mapConfig) {
                ...
                self.rendererFactory.getRenderer(mapConfig, _.extend({}, params), context, function (err, renderer) {
                    if (!err && req.profiler) {
...
RendererCache.prototype.reset = function(req){
