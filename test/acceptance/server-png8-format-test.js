...
describe('server_png8_format', function () {
    ...
    before(function (done) {
        testClientPng8 = new TestClient(layergroup, {
            mapnik: {
                grainstore: Object.assign({ mapnik_tile_format: 'png8:m=h' }, config.renderer.mapnik.grainstore)
            }
        });
        testClientPng32 = new TestClient(layergroup, {
            mapnik: {
                grainstore: Object.assign({ mapnik_tile_format: 'png' }, config.renderer.mapnik.grainstore)
            }
        });
